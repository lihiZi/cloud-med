...
function changeProduct () {
	...
	if (i ==1) {
		...
		document.getElementById("product-name").innerHTML = "Nittaya SW"
		...
		document.getElementById("product-spec").innerHTML = " An IoT stethoscope that records digital measurements dirclt to Nitatya SW"
		i++;	
	} else if (i==3){
		...
		document.getElementById("product-spec").innerHTML = " Smart Camera that process images of inner throught and records on Nittaya"
		i++;
	} else if (i==4) {
		document.getElementById("product-img").className="product-img-4";
		document.getElementById("product-name").innerHTML = "Thermo-USB"
		document.getElementById("product-spec").innerHTML = "An easy to use thermometer that recirds measurements directly on Nittaya" 
		 i=1;
	}
